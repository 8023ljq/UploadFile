...
namespace ImageServer.Controllers
{
    public class UploadController : ApiController
    {
        ...
        public IHttpActionResult UploadImgageFromWeb(string ext)
        {
            ...
            {
                resultMsg.code = -1;
                resultMsg.msg = "上传失败,文件格式必须为" + UploadFormat + "类型";
                return Ok(resultMsg);
            }
            ext = ext.ToLower();
            ...
            try
            {
                ...
                if (ext != "zip")
                {
                    ...
                    AddWaterMark.AddWaterMarks(filePath, filePath + "_img.jpeg");
                    string error = String.Empty;
                    AddWaterMark.DrawWaterImage(filePath + "_img.jpeg", filePath, waterPath,out error, "");
                }
